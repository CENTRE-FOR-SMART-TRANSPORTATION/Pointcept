...
COMBINE_LABELS = ["chevron", "arrow", "marking", "concrete_barrier", "lane", "shoulder", "vegetation", "traffic_sign", "light_pole", "lightpole", "guardrail", "highway_guardrail", "clutter"]
...
def main():
    ...
    for scene in os.listdir(data):
        ...
        for filename in os.listdir(las_files):
            ...
            print("reading las file", las_file)
            las = laspy.read(las_file)
