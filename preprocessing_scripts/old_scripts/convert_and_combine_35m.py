...
COMBINE_LABELS = ["CONC_BARR", "LANE", "LIGHT_POLE", "MARK", "SHOULDER", "TRAFFIC_SIGN", "VEG"]
# FIXED_LABEL = [
#     # 'vegetation',
#     'crossbuck',
#     'stop-sign',
...
def get_label_points(name, scene, filename_cut, orig_points, cumulative_mask, annotations, label_count, class_names, pc_min, pc_m, intensity_min, intensity_m):
    ...
    print("Total points before downsample", len(points_with_intensity))
    points = voxel_downsample(points_with_intensity, 0.3)
    print("Size after downsample", len(points))
    ...
    for box in box_list:
        ...
        #     selected_points = voxel_downsample(selected_points, 0.3)
    ...
    if len(unlabeled_points) > 0:
        ...
        #     unlabeled_points = voxel_downsample(unlabeled_points, 0.7)
...
def main():
    ...
    for scene in os.listdir(data):
        ...
        for filename in os.listdir(las_files):
            ...
            print("Total points before downsample", len(points))
