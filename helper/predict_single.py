...
model_saved = torch.load(
    '/home/gurveer/Desktop/saved/exp_non_unified_ds_2_test_10_1_train/cstdataset/semseg-pt-v2m2-0-base-multiclass/model/model_best.pth')
single_sample = torch.load(
    '/home/gurveer/Desktop/datasets/preprocessed_new/test/02002N_C1R1_R1R1_18000_20321_section_2_sar_d_points_15.pth')
original = torch.load(
    '/home/gurveer/Desktop/overfit/parsed/02002N_C1R1_R1R1_18000_20321_section_2_sar_d_points_15.pth')
...
print(matrix)
print(totals)
print_matrix(matrix, "2aperc.xlsx")
outfile = os.path.join(
    predictions_folder, f"section2_unified.txt")
