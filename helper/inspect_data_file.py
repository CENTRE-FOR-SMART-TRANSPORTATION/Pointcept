...
import os
# Load the .pth file
file_path = os.path.join(os.path.expanduser('~'), "Desktop", "datasets", "preprocessed_features", "train", "00215S_L1L1_42000_40000_section_21_sar__d_points_40_sar__d_points_35.pth")
