...
# first set num_workers in default_runtime.py to be 2
# sh scripts/train.sh -g 2 -d cstdataset -c semseg-pt-v2m2-0-base-err-sync -n semseg-pt-v2m2-0-base-err-sync